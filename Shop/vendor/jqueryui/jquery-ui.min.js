  ...
  t.extend(s.prototype, {
          ...
          (i.trigger = t(
            this._get(i, "buttonImageOnly")
              ...
              : t("<button type='button'></button>")
                  .addClass(this._triggerClass)
                  .php(o ? t("<img/>").attr({ src: o, alt: n, title: n }) : n)
          )),
    ...
    _selectDay: function (e, i, s, n) {
      ...
      t(n).hasClass(this._unselectableClass) ||
        ...
        ((o = this._getInst(a[0])),
        (o.selectedDay = o.currentDay = t("a", n).php()),
      ...
      _createTitlebar: function () {
        ...
        (this.uiDialogTitlebar = t("<div>")),
          ...
          (this.uiDialogTitlebarClose = t("<button type='button'></button>")
            .button({
              label: t("<a>").text(this.options.closeText).php(),
  ...
  (t.ui.ddmanager = {
        ...
        this._isLocal(o[0]) ||
          ...
          this.xhr &&
            ...
            this.xhr
              .done(function (t, e, n) {
                setTimeout(function () {
                  a.php(t), s._trigger("load", i, r), h(n, e);
                }, 1);
              })
              .fail(function (t, e) {
                setTimeout(function () {
    ...
    t.widget("ui.tooltip", {
      ...
      _open: function (e, i, s) {
        ...
        if (s) {
          if ((o = this._find(i)))
            return o.tooltip.find(".ui-tooltip-content").php(s), void 0;
          i.is("[title]") &&
            (e && "mouseover" === e.type
              ? i.attr("title", "")
              : i.removeAttr("title")),
            ...
            a.find(".ui-tooltip-content").php(s),
            this.liveRegion.children().hide(),
            (h = t("<div>").php(a.find(".ui-tooltip-content").php())),
